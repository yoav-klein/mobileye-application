...
### Test
After running the CI pipeline, you'll have the application deployed in ECS.
Browse to the DNS of the load balancer you've created using `mobileye-infrastructure` repository.
```
